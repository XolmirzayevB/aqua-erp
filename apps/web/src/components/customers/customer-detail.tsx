              ...
              <table className="w-full text-sm min-w-[620px]">
                ...
                <tbody>
                  {(orders?.data || []).length === 0 ? (
                    <tr>
                      <td colSpan={7} className="px-5 py-10 text-center text-gray-400 text-sm border-t border-gray-300 dark:border-gray-700">
                        Buyurtmalar yo'q
                      </td>
                    </tr>
                  ) : (
                    (orders?.data || []).map((order: any, i: number) => (
                      <tr key={order.id} className="border-t border-gray-300 dark:border-gray-700 even:bg-gray-50 dark:even:bg-gray-800/25 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
              ...
              <table className="w-full text-sm min-w-[480px]">
                ...
                <tbody>
                  {(payments?.data || []).length === 0 ? (
                    <tr>
                      <td colSpan={4} className="px-5 py-10 text-center text-gray-400 text-sm border-t border-gray-300 dark:border-gray-700">
                        To'lovlar tarixi yo'q
                      </td>
                    </tr>
                  ) : (
                    (payments?.data || []).map((payment: any) => (
                      <tr key={payment.id} className="border-t border-gray-300 dark:border-gray-700 even:bg-gray-50 dark:even:bg-gray-800/25 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
