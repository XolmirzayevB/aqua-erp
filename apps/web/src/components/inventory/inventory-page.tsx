        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm min-w-[640px]">
            ...
            <tbody>
              {!history?.data?.length ? (
                <tr>
                  <td colSpan={5} className="px-5 py-10 text-center text-gray-400 text-sm border-t border-gray-300 dark:border-gray-700">
                    Harakatlar yo'q
                  </td>
                </tr>
                ...
                return (
                  <tr key={action.id} className="border-t border-gray-300 dark:border-gray-700 even:bg-gray-50 dark:even:bg-gray-800/25 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
