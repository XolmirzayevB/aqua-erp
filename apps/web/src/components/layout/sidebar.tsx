...
export function Sidebar({ open = false, onClose }: { open?: boolean; onClose?: () => void }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed md:static inset-y-0 left-0 z-50 w-64 flex-shrink-0 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 flex flex-col transition-transform duration-200 md:translate-x-0",
