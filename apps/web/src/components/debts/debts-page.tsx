          ...
          <table className="w-full text-sm min-w-[760px]">
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={6} className="px-5 py-12 text-center border-t border-gray-100 dark:border-gray-800">
                    <div className="text-green-500 text-xl mb-1">✓</div>
                    <p className="text-gray-400 dark:text-gray-500">Qarzdor mijozlar yo'q</p>
                  </td>
                </tr>
              ) : debtors.map((d) => (
                <tr key={d.id} className="border-t border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors">
