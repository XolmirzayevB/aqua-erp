  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.7fr_1fr] gap-4 mb-4">
        ...
        <div className={cn(cardClass, "p-5")}>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="pt-2 mt-1 border-t border-gray-200 dark:border-gray-700/70 text-xs text-gray-400">
      ...
      <div className={cn(cardClass, "overflow-hidden")}>
        ...
        <div>
          {!txns?.data?.length ? (
            <div className="px-5 py-10 text-center text-gray-400 text-sm border-t border-gray-200 dark:border-gray-700/70">
              Tranzaksiyalar yo'q
            </div>
          ) : txns.data.map((t) => {
            ...
            return (
              <div
                key={t.id}
                className="flex items-center gap-3.5 px-5 py-3 border-t border-gray-200 dark:border-gray-700/70 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors"
              >
                <span className={cn(
