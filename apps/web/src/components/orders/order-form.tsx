              ...
              <div className="relative">
                ...
                {showDrop && (
                  <div className="absolute top-full mt-1 left-0 right-0 z-20 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden">
                    ...
                    <button type="button" onClick={() => setShowDrop(false)} className="w-full py-2 text-xs text-gray-500 border-t border-gray-200 dark:border-gray-700/70">Yopish</button>
                  </div>
                )}
              </div>
              {selected && (
